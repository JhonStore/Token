...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY JHON            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "ayangtessa" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke Jhon${NC}"
    echo -e "${YELLOW}TELEGRAM : @jhonchristoy${NC}"
    echo -e "${YELLOW}WHATSAPP : 628977462304${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 25K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}© Jhon${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer 𝙅𝙃𝙊𝙉 𝙍𝙀𝙑𝙄𝙎𝙄𝙊𝙉   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : Jhonchristoy     ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : 𝙅𝙃𝙊𝙉 𝙍𝙀𝙑𝙄𝙎𝙄𝙊𝙉  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by 𝙅𝙃𝙊𝙉 𝙍𝙀𝙑𝙄𝙎𝙄𝙊𝙉  ${NC}"
